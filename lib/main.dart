...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Mega Sena  '),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<Card> selectedNumbersCards = [];
  ...
  void _bet() {
    setState(() {
      ...
      for (int sn in selectedNumbers) {
        selectedNumbersCards.add(Card(
          elevation: 5,
